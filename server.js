...
app.prepare().then(() => {
  ...
  router.post("/api/rates", async (ctx) => {
    ...
    await ctx.app.pool.query("UPDATE exchange_rates SET value=" + usdeur + " WHERE key = 'USDEUR'");
    await ctx.app.pool.query("UPDATE exchange_rates SET value=" + usdgbp + " WHERE key = 'USDGBP'");
