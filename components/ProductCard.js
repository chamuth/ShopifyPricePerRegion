  ...
  const saveProduct = (e) => {
    ...
    Object.keys(prices).forEach((SKU) => {
      ...
      const originalVariant = {
        ...
        compareAtPrice: (USD_compareAtPrice != "") ? USD_compareAtPrice.toString() : null,
      ...
      const EURVariant = {
        ...
        compareAtPrice: (EUR_compareAtPrice != "") ? EUR_compareAtPrice.toString() : null,
      ...
      const GBPVariant = {
        ...
        compareAtPrice: (GBP_compareAtPrice != "") ? GBP_compareAtPrice.toString() : null,
